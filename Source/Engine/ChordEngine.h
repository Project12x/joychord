#pragma once
#include <cstdint>
#include <ghostmoon/Containers.h>

// Use ghostmoon's canonical FixedArray/FixedString (extracted from this file)
template <size_t N>
using FixedString = gm::FixedString<N>;
template <typename T, size_t Cap>
using FixedArray = gm::FixedArray<T, Cap>;
